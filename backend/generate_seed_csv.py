...
EXAM_BLUEPRINTS = [
    {
        ...
        "questions": [
            ...
            ("multiple_choice", "Which metric tracks whether your head is facing the camera?", ["Face presence", "Identity match", "Head facing camera", "Posture compliance"], "Head facing camera"),
            ("true_false", "Looking away from the camera may trigger monitoring alerts.", ["True", "False"], "True"),
